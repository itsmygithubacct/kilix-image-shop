...
class ClosedCompilerTests(CompilerFixture):
    ...
    def test_slice_four_builds_and_caches_one_complete_native_proxy_level(self) -> None:
        ...
        self.assertEqual(diagnostics.tile_cache_ceiling_bytes, 256 * 1024 * 1024)
        ...
        self.assertEqual(diagnostics.timing.sample_count, 1)
        self.assertIsNone(diagnostics.swap.quota_bytes)
